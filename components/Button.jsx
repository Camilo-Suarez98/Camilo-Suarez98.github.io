...
=======
                <a className="projects buttons-color-letter w-48 mt-3 text-center mr-2 rounded-3xl py-5 text-indigo-50 font-bold transition-all duration-500 hover:text-blue-50 hover:bg-blue-500 active:transform hover:-translate-y-3 ls:mr-0 ls:mb-2" rel="noreferrer">
...
=======
                <a className="projects buttons-color-letter w-48 mt-3 text-center ml-2 rounded-3xl py-5 text-indigo-50 font-bold transition-all duration-500 hover:text-blue-50 hover:bg-blue-700 active:transform hover:-translate-y-3 ls:ml-0 ls:mt-2" rel="noreferrer">
>>>>>>> 8902ae5fb1460ecc1f3a39f39e3246624d0dc517
                    Contact me
                </a>
            </Link>
