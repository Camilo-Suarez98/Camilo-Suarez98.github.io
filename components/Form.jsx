...
const Form = () => {
    return (
        <form className="text-gray-800 bg-blue-100 text-center border-2 border-gray-300 w-96 m-auto rounded-xl py-10" action="https://formspree.io/f/xayagopa" method="POST">
            ...
            <br />
            <br />
            <input className="bg-blue-800 text-blue-50 font-bold p-2.5 w-24 rounded-md cursor-pointer transition-all duration-500 hover:text-gray-500 active:transform hover:translate-y-1" type="submit" value="Submit" />
        </form>
    )
}
