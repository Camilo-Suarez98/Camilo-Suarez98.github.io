...
const ProjectCard = ({ project }) => {
  return (
    <div className="projects w-11/12 p-6 self-center justify-self-center transition-all duration-500 rounded-lg h-full hover:border-gray-100 hover:bg-gray-300 md:w-72 sm:w-60">
